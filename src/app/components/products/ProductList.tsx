  ...
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden w-full sm:w-full md:w-full lg:w-full transition-transform transform hover:scale-105">
      ...
      <div className="p-4">
        ...
        <p className="text-gray-600 h-20 text-sm mt-1">{product.description}</p>
        <div className="flex justify-between items-center mt-3">
          <span className="text-xl font-bold text-blue-600">₦{product.price}</span>
          <button 
            onClick={handlePurchase}
            className="flex cursor-pointer items-center bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition"
          >
